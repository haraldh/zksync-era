...
#[metrics(prefix = "sgx_witness_input_producer")]
pub(crate) struct SGXWitnessInputProducerMetrics {
...
#[vise::register]
pub(super) static METRICS: vise::Global<SGXWitnessInputProducerMetrics> = vise::Global::new();
